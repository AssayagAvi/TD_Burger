package refractor.client;

import refractor.api.general.*;

import java.util.Arrays;
import java.util.List;

import static refractor.api.general.Meat.MeatType.*;
import static refractor.api.general.Sauce.SauceType.*;
